...
function media() {
  return src("./media/*.{mp3,mp4,webm}").pipe(dest("dist/media/"));
}
...
function serve() {
  ...
  watch("./css/**.css", series(css)).on("change", sync.reload);
  // watch('src/js/**.js', series(js)).on('change', sync.reload)
}
exports.build = series(del, images, media, js, css, cssbs, html);
exports.serve = series(del, images, media, js, css, cssbs, html, serve);
// exports.clear = del
